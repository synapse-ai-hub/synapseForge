...
Gracias por contribuir a `synapseForge`. Este documento resume las normas y buenas prácticas para contribuir de manera ordenada.
...
fix: corregir null pointer en utils
